            ...
            <div className="container mx-auto px-4 py-8 sm:py-10 lg:py-12">
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
                    ...
                    <div className="flex flex-col items-center sm:items-start">
                        ...
                        <p className="text-white/90 text-xs sm:text-sm text-center sm:text-left leading-relaxed">
                    ...
                    {/* Links Importantes */}
                    <div className="flex flex-col items-center sm:items-start">
                        <h3 className="font-bold text-base sm:text-lg mb-3 sm:mb-4">Institucional</h3>
                    ...
                    <div className="flex flex-col items-center sm:items-start">
                        ...
                        <div className="flex flex-col space-y-2 sm:space-y-3 text-center sm:text-left">
                            <a
                                ...
                                className="flex items-center gap-2 text-white/90 hover:text-white transition-colors text-xs sm:text-sm justify-center sm:justify-start"
                            >
                            ...
                            <div className="flex items-center gap-2 text-white/90 text-xs sm:text-sm justify-center sm:justify-start">
                    ...
                    <div className="flex flex-col items-center sm:items-start">
                        <h3 className="font-bold text-base sm:text-lg mb-3 sm:mb-4">Pagamento Seguro</h3>
                        ...
                        {/* Selo de Segurança */}
                        <div className="flex items-center gap-2 bg-white/10 backdrop-blur-sm rounded-lg px-2.5 sm:px-3 py-1.5 sm:py-2 w-full sm:w-auto">
                            <Shield className="w-4 h-4 sm:w-5 sm:h-5 text-green-300 flex-shrink-0" />
                            <div>
                                <p className="text-[10px] sm:text-xs font-semibold">Site Seguro</p>
                                <p className="text-[9px] sm:text-[10px] text-white/80">Criptografia SSL</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="border-t border-white/20 mt-6 sm:mt-8 pt-4 sm:pt-6">
                    <div className="flex flex-col sm:flex-row justify-between items-center gap-3 sm:gap-4 text-xs sm:text-sm">
                        ...
                        <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="text-white/90 hover:text-white transition-colors text-center sm:text-right"
                        >
